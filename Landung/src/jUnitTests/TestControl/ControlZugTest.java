...
public class ControlZugTest {
	...
	@Test
	public void testGueltigeEingabe() {
		String eingabe1 = "a1b2";
		String eingabe2 = "a331";
		String eingabe3 = "A4b1";
		String eingabe4 = "345a";
		String eingabe5 = "1a3b";
		
		assertTrue(ControlZug.gueltigeEingabe(eingabe1));
		assertFalse(ControlZug.gueltigeEingabe(eingabe2));
		assertFalse(ControlZug.gueltigeEingabe(eingabe3));
		assertFalse(ControlZug.gueltigeEingabe(eingabe4));
		assertFalse(ControlZug.gueltigeEingabe(eingabe5));
